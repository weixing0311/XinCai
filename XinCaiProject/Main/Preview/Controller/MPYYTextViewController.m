...
-(void)layoutPageView
{
    ...
    NSString *bAllString=@"这个是一个高度显示的效果，测试文本内容的长度控制，并且显示文体的内容，测试文本内容的长度控制，并且显示文体的内容，测试文本内容的长度控制，并且显示文体的内容，XinCaiProject项目的内容";
    NSString *bHeightString=@"XinCaiProject";
    ...
    [bAttributedString yy_setTextHighlightRange:brange
                                ...
                                backgroundColor:[UIColor grayColor]
                                      tapAction:^(UIView *containerView, NSAttributedString *text, NSRange range, CGRect rect){
                                          DDLogError(@"你点击高亮效果（XinCaiProject）");
                                      }];
    ...
    //4：YYLable带边框效果
    NSMutableAttributedString *cAttributedString=[[NSMutableAttributedString alloc]initWithString:@"XinCaiProject"];
