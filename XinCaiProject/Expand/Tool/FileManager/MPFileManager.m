...
+ (NSString *)downloadPath{
    ...
    NSString *downloadPath = [documentPath stringByAppendingPathComponent:@"XinCaiProject_Download"];
    return downloadPath;
}
...
+ (NSString *)uploadPath{
    NSString *documentPath = [NSSearchPathForDirectoriesInDomains(NSDocumentDirectory, NSUserDomainMask, YES) firstObject];
    NSString *uploadPath = [documentPath stringByAppendingPathComponent:@"XinCaiProject_Upload"];
    return uploadPath;
}
